...
<html lang="en">
  <head>
    ...
    <link href="{{ asset('web')}}/../../css.css?family=Muli:300,400,700|Playfair+Display:400,700,900" rel="stylesheet">
...
<script async="" src="{{ asset('web')}}/../../gtag/js.js?id=UA-23581568-13"></script>
<script>
